                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:logoInstance, field:'id')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:logoInstance, field:'image')}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name">Anio:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:logoInstance, field:'anio')}</td>
