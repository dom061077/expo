	...
	def export = {
		...
		List list = consultar2(params)	   	
		 ...
		 sheet.addCell(new Label(5, fil, "Total"))
	 	 sheet.addCell(new Label(6, fil, "Total Cancelado"))
	 	 sheet.addCell(new Label(7, fil, "Saldo"))
 	 	 sheet.addCell(new Label(8, fil, "Exposición"))
	 	 sheet.addCell(new Label(9, fil, "Año")) 	 	 
	 	 sheet.addCell(new Label(10, fil, "Número de Orden"))
	 	 sheet.addCell(new Label(11, fil, "Fecha Alta"))	 	 
	 	 sheet.addCell(new Label(12, fil, "Razón Social"))
		 sheet.addCell(new Label(13,fil, "C.U.I.T"))
		 sheet.addCell(new Label(14,fil, "Dirección"))
		 sheet.addCell(new Label(15,fil, "E-mail")) 
		 sheet.addCell(new Label(16,fil, "Nombre Representante"))
		 sheet.addCell(new Label(17,fil, "D.N.I Representante"))
		 sheet.addCell(new Label(18,fil, "Telefono 1 Representante"))
		 sheet.addCell(new Label(19,fil, "Telefono 2 Representante"))
		 sheet.addCell(new Label(20,fil, "Telefono 3 Representante"))
		 sheet.addCell(new Label(21,fil, "Sitio Web"))
		 sheet.addCell(new Label(22,fil, "Rubro"))
		 sheet.addCell(new Label(23,fil, "Sub-Rubro"))
		 sheet.addCell(new Label(24,fil, "Vendedor"))
		 sheet.addCell(new Label(25,fil, "Provincia"))
		 sheet.addCell(new Label(26,fil, "Localidad"))
		 sheet.addCell(new Label(27,fil, "Observacion"))
		 ...
		 list.each{
    				...
    				if(it instanceof DetalleServicioContratado){
    					...
    					sheet.addCell(new Number(6,fil,totalCancelado))
    					sheet.addCell(new Number(7,fil,saldo))
    					sheet.addCell(new Label(8,fil,it.ordenReserva.expo.nombre))
    					sheet.addCell(new Number(9,fil,it.ordenReserva.anio))
    					sheet.addCell(new Number(10,fil,it.ordenReserva.numero))
    					sheet.addCell(new DateTime(11,fil,it.ordenReserva.fechaAlta,dateFormat))
						sheet.addCell(new Label(12,fil,it.ordenReserva.empresa.razonSocial))
						sheet.addCell(new Label(13,fil,it.ordenReserva.empresa.cuit))
						sheet.addCell(new Label(14,fil,it.ordenReserva.empresa.direccion))
						sheet.addCell(new Label(15,fil,it.ordenReserva.empresa.email))
						sheet.addCell(new Label(16,fil,it.ordenReserva.empresa.nombreRepresentante))
						sheet.addCell(new Label(17,fil,it.ordenReserva.empresa.dniRep))
						sheet.addCell(new Label(18,fil,it.ordenReserva.empresa.telefonoRepresentante1))
						sheet.addCell(new Label(19,fil,it.ordenReserva.empresa.telefonoRepresentante2))
						sheet.addCell(new Label(20,fil,it.ordenReserva.empresa.telefonoRepresentante3))
						sheet.addCell(new Label(21,fil,it.ordenReserva.empresa.sitioWeb))
						sheet.addCell(new Label(23,fil,it.ordenReserva.empresa.subrubro?.rubro?.nombreRubro))
						sheet.addCell(new Label(23,fil,it.ordenReserva.empresa.subrubro?.nombreSubrubro))
						sheet.addCell(new Label(24,fil,it.ordenReserva.empresa.vendedor.nombre))
						sheet.addCell(new Label(25,fil,it.ordenReserva.empresa.localidad?.provincia?.nombre))
						sheet.addCell(new Label(26,fil,it.ordenReserva.empresa.localidad?.nombreLoc))
						sheet.addCell(new Label(27,fil,it.ordenReserva.observacion))
    					...
    					sheet.addCell(new Number(6,fil,totalCancelado)) 
    					sheet.addCell(new Number(7,fil,saldo))
    					sheet.addCell(new Label(8,fil,it.expo.nombre))
    					sheet.addCell(new Number(9,fil,it.anio))
    					sheet.addCell(new Number(10,fil,it.numero))
    					sheet.addCell(new DateTime (11,fil,it.fechaAlta,dateFormat))
						sheet.addCell(new Label(12,fil,it.razonSocial))
						sheet.addCell(new Label(13,fil,it.cuit))
						sheet.addCell(new Label(14,fil,it.direccion))
						sheet.addCell(new Label(15,fil,it.email))
						sheet.addCell(new Label(16,fil,it.nombreRepresentante))
						sheet.addCell(new Label(17,fil,it.dniRep))
						sheet.addCell(new Label(18,fil,it.telefonoRepresentante1))
						sheet.addCell(new Label(19,fil,it.telefonoRepresentante2))
						sheet.addCell(new Label(20,fil,it.telefonoRepresentante3))
						sheet.addCell(new Label(21,fil,it.empresa.sitioWeb))
						sheet.addCell(new Label(22,fil,it.empresa.subrubro?.rubro?.nombreRubro))
						sheet.addCell(new Label(23,fil,it.empresa.subrubro?.nombreSubrubro))
						sheet.addCell(new Label(24,fil,it.empresa.vendedor.nombre))
						sheet.addCell(new Label(25,fil,it.empresa.localidad?.provincia?.nombre))
						sheet.addCell(new Label(26,fil,it.empresa.localidad?.nombreLoc))
						sheet.addCell(new Label(27,fil,it.observacion))
