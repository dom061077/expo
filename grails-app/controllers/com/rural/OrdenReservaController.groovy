    			...
    			list?.each{
    				...
    				if(it instanceof DetalleServicioContratado){
                        ...
                        if(it.ordenReserva.descuentosPorFecha.size()>0){
                           ...
                           detalleDescHtml=detalleDescHtml+"<th>Descripción del Descuento</th>"
		...
		List list = consultar2(params)	   	
		 ...
		 sheet.addCell(new Label(10, fil, "\$ Recibos"))
	 	 sheet.addCell(new Label(11, fil, "Saldo"))
 	 	 sheet.addCell(new Label(12, fil, "Exposici�n"))
	 	 sheet.addCell(new Label(13, fil, "A�o")) 	 	 
	 	 sheet.addCell(new Label(14, fil, "N�mero de Orden"))
	 	 sheet.addCell(new Label(15, fil, "Fecha Alta"))	 	 
	 	 sheet.addCell(new Label(16, fil, "Raz�n Social"))
		 sheet.addCell(new Label(17,fil, "C.U.I.T"))
		 sheet.addCell(new Label(18,fil, "Direcci�n"))
